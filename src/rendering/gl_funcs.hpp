...
#ifndef __A2E_GL_FUNCS_HPP__
#define __A2E_GL_FUNCS_HPP__
...
// since Apple didn't define glRenderbufferStorageMultisampleCoverageNV (probably b/c it's not supported), we have to define it on our own
...
#define GL_MAX_MULTISAMPLE_COVERAGE_MODES_NV 0
#define GL_MULTISAMPLE_COVERAGE_MODES_NV 0
