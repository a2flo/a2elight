...
gui_file_save_dialog::gui_file_save_dialog(const string& directory,
...
gui_file_save_dialog::~gui_file_save_dialog() {
}

void gui_file_save_dialog::open(const string directory, const bool write_history) {
