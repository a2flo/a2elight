...
public:
	...
	a2e_constexpr matrix4() noexcept :
	data({{
		(T)1, (T)0, (T)0, (T)0,
		(T)0, (T)1, (T)0, (T)0,
		(T)0, (T)0, (T)1, (T)0,
	...
	a2e_constexpr matrix4(const matrix4<T>* m4) noexcept : data(m4->data) {}
	a2e_constexpr matrix4(const T& m0, const T& m1, const T& m2, const T& m3,
	...
	a2e_constexpr matrix4(const vector4<T>& col_0, const vector4<T>& col_1, const vector4<T>& col_2, const vector4<T>& col_3) noexcept :
	data({{
	...
	template <typename U> a2e_constexpr matrix4(const matrix4<U>& mat4) noexcept :
	data({{
